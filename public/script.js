...
// room
openCreateRoomBox.addEventListener("click", () => {
  gameplayChoices.style.display = "none";
  createRoomBox.style.display = "block";
});

cancelCreateActionBtn.addEventListener("click", () => {
...
openJoinRoomBox.addEventListener("click", () => {
  gameplayChoices.style.display = "none";
  joinBoxRoom.style.display = "block";
});

cancelJoinActionBtn.addEventListener("click", () => {
  gameplayChoices.style.display = "block";
  createRoomBox.style.display = "none";
});
...
const playerJoinTheGame = (playerId) => {
  if (playerId === 1) {
